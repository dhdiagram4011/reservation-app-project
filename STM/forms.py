...
class joinForm(forms.ModelForm):
    ...
    bln = forms.TextInput(label="사업자등록번호", widget=forms.TextInput(attrs={'placeholder':'사업자등록번호'}))
    stamp_design = forms.TextInput(label="쿠폰도장디자인", widget=forms.TextInput(attrs={'placeholder':'쿠폰도장디자인'}))
