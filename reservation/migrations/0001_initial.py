    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_date', models.DateTimeField(default=datetime.datetime(2020, 6, 2, 12, 24, 48, 110810, tzinfo=utc))),
                ...
                ('Price', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='reservation.price')),
                ('SeatClass', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='reservation.seatClass')),
            ],
        ),
        migrations.CreateModel(
            name='emailTicket',
            fields=[
                ...
                ('daytogo', models.DateField()),
                ('comingDay', models.DateField()),
                ('created_date', models.DateTimeField(default=datetime.datetime(2020, 6, 2, 12, 24, 48, 112036, tzinfo=utc))),
                ('FlightAircraft', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='reservation.flightAircraft')),
                ('FlightNumber', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='reservation.flightNumber')),
                ('Price', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='reservation.price')),
                ('SeatClass', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='reservation.seatClass')),
