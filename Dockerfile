...
CMD git clone -b develop https://github.com/dhdiagram4011/reservation-app-project.git
CMD cd /app/reservation-app-project
RUN pip3 install -r /app/reservation-app-project/requirements.txt
RUN yum update -y
EXPOSE 80
CMD nohup python3 manage.py runserver 0:80 &
